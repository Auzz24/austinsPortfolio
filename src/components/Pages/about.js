...
function About() {
    return(
        ...
        <section id="aboutMeDiv">
            ...
            <p>
                Austin Miller is a full-stack web developer, with a specialization in the MERN stack, and RESTful Api's. Here are some other languages he is efficient in: 
            </p>
